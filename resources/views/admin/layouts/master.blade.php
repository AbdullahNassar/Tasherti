    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <!-- BEGIN page-container -->
            ...
            <!-- BEGIN CORE PLUGINS
                ...
                <script src="{{asset('assets/admin/main2.js')}}" type="text/javascript"></script>
                <script src="{{asset('assets/admin/main3.js')}}" type="text/javascript"></script>
