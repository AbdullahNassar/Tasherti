        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo" style="background-color: #26344b;">
                        <a href="{{route('admin.home')}}" style="color: #fff; margin-top: 10px; font-size: xx-large; margin-left: 12px; margin-bottom: 15px;"> Tasherti
                        </a> 
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                                ...
                                <ul class="dropdown-menu">
                                    <li style="text-align: center; background-color: #eef1f5;">
                                        <a href="{{route('markAsRead')}}" style="color: red;">Mark All As Read</a>
                                    </li>
                                    <li>
