                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.cats.edit' , ['id' => $category->c_id]) }}" class="btn green"><i class="fa fa-edit"></i> Edit   </a>  
                                                        <button class="btn btn-danger btndelet" data-url="{{ route('admin.cats.delete' , ['id' => $category->c_id]) }}" >
