                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{$post->translated()->head}}
                                                    </td>
                                                    <td style="max-width: 350px;">
                                                        @php
                                                        $brief = substr($post->translated()->content, 0, 200);
                                                        @endphp
                                                        {{strip_tags($brief)}}...
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('admin.post.edit' , ['id' => $post->id]) }}" class="btn green"><i class="fa fa-edit"></i> Edit   </a><br><br>
                                                        <button class="btn btn-danger btndelet" data-url="{{ route('admin.post.delete' , ['id' => $post->id]) }}" >
