                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{ route('admin.category.edit' , ['id' => $category->cat_id]) }}" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return false;">
                                        <div class="form-body">
                                            {{ csrf_field() }}
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="choose-img">
                                                        ...
                                                        <input type="hidden" name="image" value="{{$category->image}}" id="img" >
                                                        <input type="file" name="image" id="image" required>
                                                        <img src="{{asset('storage/uploads/icons').'/'.$category->image}}"/>
                                                    </div><!-- End Choose-Img -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" name="active" required>
                                                                <option selected value="{{ $category->active }}">@if($category->active == 1)
                                                                                Active
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="hidden" name="s_id" value="{{ $category->cat_id }}">
                                                        <input type="text" value="{{$category->cat_name_ar}} " name="cat_name_ar" class="form-control " placeholder="Category Name in Arabic..." required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{$category->cat_name_en}} " name="cat_name_en" class="form-control " placeholder="Category Name in English..." required> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
