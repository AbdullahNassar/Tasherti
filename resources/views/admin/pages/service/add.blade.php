                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="{{route('admin.service.add')}}" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return false;">
                                        <div class="form-body">
                                            {{ csrf_field() }}
                                            <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Service Rate :</label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon ">
                                                            <i class="fa fa-gift"></i>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Service Name in English :</label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon ">
                                                            <i class="fa fa-user"></i>
                                                        </span>
                                                        <input type="text" name="name_en" class="form-control " placeholder="Service Name in English ..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Service Name in Arabic :</label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <span class="input-group-addon ">
                                                            <i class="fa fa-user"></i>
                                                        </span>
                                                        <input type="text" name="name_ar" class="form-control " placeholder="Service Name in Arabic..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea type="text" rows="5" name="content_en" class="form-control " placeholder="Service Content in English..."></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea type="text" rows="5" name="content_ar" class="form-control " placeholder="Service Content in Arabic..."></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
