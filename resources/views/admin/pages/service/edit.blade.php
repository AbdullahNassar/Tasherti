                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{$service->name_en}}" name="name" class="form-control " placeholder="Service Name in English ..." required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea rows="5" type="text" name="content_en" class="form-control " placeholder="Service Content in English...">{{$service->content_en}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
