                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{ route('admin.slider.edit' , ['id' => $slider->id]) }}" class="form-horizontal" enctype="multipart/form-data" method="slider" onsubmit="return false;">
                                        <div class="form-body">
                                            {{ csrf_field() }}
                                            <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{$slider->head1_en}} " name="head1_en" class="form-control " placeholder="Header 1 in English..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{$slider->head1_ar}} " name="head1_ar" class="form-control " placeholder="Header 1 in Arabic..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{$slider->head2_en}} " name="head2" class="form-control " placeholder="Header 2 in English..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{$slider->head2_ar}} " name="head2_ar" class="form-control " placeholder="Header 2 in Arabic..."> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea rows="10" name="content_en" class="form-control " placeholder="slider Content in English...">{{$slider->content_en}}</textarea> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea rows="10" name="content_ar" class="form-control " placeholder="slider Content in Arabic...">{{$slider->content_ar}}</textarea> 
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
